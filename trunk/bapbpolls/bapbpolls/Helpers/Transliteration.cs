...
namespace Translit
{
    ...
    {
        private Dictionary<String, String> gost = new Dictionary<String, String>(); //ГОСТ 16876-71   
        private Dictionary<String, String> iso = new Dictionary<String, String>(); //ISO 9-95 016   
        ...
        private string Back(string text)
        {
            return Back(text, TransliterationType.ISO);
        }

        private string Back(string text, TransliterationType type)
        {
            string output = text;
            Dictionary<String, String> tdict = GetDictionaryByType(type);
