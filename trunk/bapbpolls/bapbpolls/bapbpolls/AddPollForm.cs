...
namespace bapbpolls
{
    public partial class AddPollForm : AddChangeRecordForm
    {
        ...
        {
            // TODO: This line of code loads data into the 'pollsDataSet.TYPEPOLLS' table. You can move, or remove it, as needed.
            this.tYPEPOLLSTableAdapter.Fill(this.pollsDataSet.TYPEPOLLS);
