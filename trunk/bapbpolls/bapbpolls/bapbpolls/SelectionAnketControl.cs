...
namespace bapbpolls
{
    public partial class SelectionAnketControl : UserControl
    {
        ...
        private void LoadRegions()
        {
            ...
            //pollsDataSet.FILIAL.AddFILIALRow()

            //pollsDataSet.FILIALVIEW.Clear();
            //pollsDataSet.FILIALVIEW.AddFILIALVIEWRow("<Любой>", 000);

            //fILIALVIEWTableAdapter.ClearBeforeFill = false;
            fILIALVIEWTableAdapter.Fill(pollsDataSet.FILIALVIEW,System.DateTime.Now);
        ...
        {
            LoadQuarter(Convert.ToInt32(comboBoxYear.SelectedValue));
            SelectionChange();            
        ...
        private void SelectionChange()
        {
            ...
            {
                if (comboBoxQuarter.SelectedValue!=null)
                {
