...
namespace Russian.SummaPropisiu
{
    /// <summary>
    /// Класс для записи денежных сумм прописью: "тысяча рублей 00 копеек".
    /// </summary>
    /// <example>
    /// Сумма.Propis (100, Currency.Rubl); // "сто рублей 00 копеек"
    /// Currency.Rubl.Propis (123.45); // "сто двадцать три рубля 45 копеек"
    /// </example>
    public static class Summa
    {
        ...
        /// </summary>
        public static StringBuilder Propis(decimal сумма, Currency валюта, StringBuilder result)
        {
            decimal целая = Math.Floor(сумма);
            uint дробная = (uint)((сумма - целая) * 100);

            Число.Propis(целая, валюта.ОсновнаяЕдиница, result);
        ...
        /// Записывает пропись суммы в заданной валюте в <paramref name="result"/> строчными буквами.
        /// </summary>
        public static StringBuilder Propis(double сумма, Currency валюта, StringBuilder result)
        {
            ...
            return Число.Propis(целая, валюта.ОсновнаяЕдиница, result);
             //ДобавитьКопейки(дробная, валюта, result);
        }

        private static StringBuilder ДобавитьКопейки(uint дробная, Currency валюта, StringBuilder result)
        {
            result.Append(' ');
        ...
        /// <see cref="Summa.Propis (decimal, Currency)"/>.
        /// </summary>
        /// <remarks>
        /// Summa должна быть неотрицательной и должна содержать 
        ...
        {
            if (сумма < 0) return "Summa должна быть неотрицательной.";
        ...
        /// </summary>
        public static string Propis(decimal n, Currency валюта)
        {
            return Число.ApplyCaps(Propis(n, валюта, new StringBuilder()), Заглавные.Нет);
        }

        /// <summary>
        /// Возвращает пропись заданной суммы.
        /// </summary>
        public static string Propis(decimal n, Currency валюта, Заглавные заглавные)
        {
            return Число.ApplyCaps(Propis(n, валюта, new StringBuilder()), заглавные);
        }

        /// <summary>
        /// Возвращает пропись заданной суммы строчными буквами.
        /// </summary>
        public static string Propis(double n, Currency валюта)
        {
            return Число.ApplyCaps(Propis(n, валюта, new StringBuilder()), Заглавные.Нет);
        }
        ...
        /// Возвращает пропись заданной суммы.
        /// </summary>
        public static string Propis(double n, Currency валюта, Заглавные заглавные)
        {
            return Число.ApplyCaps(Propis(n, валюта, new StringBuilder()), заглавные);
        }
    }
    ...
    /// </summary>
    /// <example>
    /// Число.Propis (1, РодЧисло.Мужской); // "один"
    /// Число.Propis (2, РодЧисло.Женский); // "две"
    /// Число.Propis (21, РодЧисло.Средний); // "двадцать одно"
    /// </example>
    /// <example>
    /// Число.Propis (5, new ЕдиницаИзмерения (
    ...
    public static class Число
    {
        ...
        /// <summary>
        /// Проверяет, подходит ли число для передачи методу 
        /// <see cref="Propis(decimal,IЕдиницаИзмерения,StringBuilder)"/>.
        /// </summary>
        /// <returns>
        /// Описание нарушенного ограничения или null.
        /// </returns>
        ...
        /// <summary>
        /// Проверяет, подходит ли число для передачи методу 
        /// <see cref="Propis(double,IЕдиницаИзмерения,StringBuilder)"/>.
        /// </summary>
        /// <returns>
        /// Описание нарушенного ограничения или null.
        /// </returns>
        ...
        #region Перегрузки метода Propis, возвращающие string

        /// <summary>
        /// Возвращает пропись числа строчными буквами.
        /// </summary>
        public static string Propis(decimal число, IЕдиницаИзмерения еи)
        {
        ...
        /// </summary>
        public static string Propis(decimal число, IЕдиницаИзмерения еи, Заглавные заглавные)
        {
        ...
        /// Возвращает пропись числа строчными буквами.
        /// </summary>
        public static string Propis(double число, IЕдиницаИзмерения еи)
        {
            return Propis(число, еи, Заглавные.Нет);
        }
        ...
        /// Возвращает пропись числа.
        /// </summary>
        public static string Propis(double число, IЕдиницаИзмерения еи, Заглавные заглавные)
        {
            return ApplyCaps(Propis(число, еи, new StringBuilder()), заглавные);
        }
        ...
        /// Возвращает пропись числа строчными буквами.
        /// </summary>
        public static string Propis(ulong число, IЕдиницаИзмерения еи)
        {
            return Propis(число, еи, Заглавные.Нет);
        }
        ...
        /// Возвращает пропись числа.
        /// </summary>
        public static string Propis(ulong число, IЕдиницаИзмерения еи, Заглавные заглавные)
        {
            return ApplyCaps(Propis(число, еи, new StringBuilder()), заглавные);
        }
    ...
    public class Currency
    {
        ...
        public static readonly Currency Rubl = new Currency(
            new ЕдиницаИзмерения(РодЧисло.Мужской, "белорусский рубль", "белорусских рубля", "белорусских рублей"),
        ...
        /// </summary>
        public string Propis(decimal сумма)
        {
            return Summa.Propis(сумма, this);
        }

        /// <summary>
        /// Возвращает пропись суммы строчными буквами.
        /// </summary>
        public string Propis(double сумма)
        {
            return Summa.Propis(сумма, this);
        }
        ...
        /// </summary>
        public string Propis(decimal сумма, Заглавные заглавные)
        {
            return Summa.Propis(сумма, this, заглавные);
        }

        /// <summary>
        /// Возвращает пропись суммы.
        /// </summary>
        public string Propis(double сумма, Заглавные заглавные)
        {
            return Summa.Propis(сумма, this, заглавные);
        }
    }
    ...
    /// <see cref="Число.Propis(decimal,IЕдиницаИзмерения,StringBuilder)"/>.
    /// Управляет родом и числом числительных один и два.
    /// </summary>
    /// <example>
    /// Число.Propis (2, РодЧисло.Мужской); // "два"
    /// Число.Propis (2, РодЧисло.Женский); // "две"
    /// Число.Propis (21, РодЧисло.Средний); // "двадцать одно"
    /// </example>
